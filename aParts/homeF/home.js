  ...
  render() {
    return (
      <View>
        ...
        <Text>
        I have a decent knowledge of my home town and am always eager to learn and experience more. In fact, I thrive on them; things that I have never done before, even if I feel a bit intimidated. </Text>
        <Text>
